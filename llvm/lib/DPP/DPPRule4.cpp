...
ValSet DPPRule4G::GetCompleteUsers(const Value *Val, SVFG *svfg) {
...
DPPRule4G::Result DPPRule4G::run(Module &M, AnalysisManager<Module> &AM) {
    Result Result {};
    ...
    LLVM_DEBUG(dbgs() << "Running rule 4...\n");
...
raw_ostream &DPPRule4GResult::print(raw_ostream &OS) const {
    OS << "Prioritized data objects by Rule 4:\n";
