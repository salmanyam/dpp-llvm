...
PreservedAnalyses AddressSanitizerPass::run(Function &F, AnalysisManager<Function> &AM) {
...
PreservedAnalyses ModuleAddressSanitizerPass::run(Module &M, AnalysisManager<Module> &AM) {
